...
<div class="card card-outline card-danger rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-danger"><span class="fas fa-plus"></span>  Add New Schedule</a>
		</div>
	</div>
	<div class="card-body">
        <div class="container-fluid">
			<div class="row my-2">
				<a href="./?page=schedules" class="btn btn-flat col-md-3 text-center <?= $type == 1 ? "btn-danger" : 'btn-light border' ?>"><i class="fa fa-calendar"></i> Daily Schedules</a>
				<a href="./?page=schedules&type=2" class="btn btn-flat col-md-3 text-center <?= $type == 2 ? "btn-danger" : 'btn-light border' ?>"><i class="fa fa-calendar-day"></i> One-Time Schedules</a>
			</div>
