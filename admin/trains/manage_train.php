...
<div class="container-fluid">
    <form action="" id="train-form">
        ...
        <div class="form-group">
            <label for="code" class="control-label">Flights</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter flight Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
