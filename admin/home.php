...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-danger shadow">
            <span class="info-box-icon bg-gradient-warning elevation-1"><i class="fas fa-plane-departure"></i></span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-danger shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Daily Flights</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-danger shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">One-Time Flights</span>
            <span class="info-box-number text-right">
                <?php 
