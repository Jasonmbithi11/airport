                        ...
                        <fieldset>
                            ...
                            <form action="" id="filter-schedule">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <button class="btn btn-flat btn-danger"><i class="fa fa-search"></i> Search</button>
                                    </div>
                                </div>
                            </form>
                        </fieldset>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-1" align="center">
                                        <a href="./?page=reserve&sid=<?= $row['id'] ?>" class="btn btn-flat btn-danger btn-sm" >Book <i class="fa fa-angle-right"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
